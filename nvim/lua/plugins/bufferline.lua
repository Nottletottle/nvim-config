return {
	...
	config = function()
		...
		vim.keymap.set("n", "gtb", "<CMD>BufferLinePick<CR>")
		vim.keymap.set("n", "brm", "<CMD>BufferLinePickClose<CR>")
		vim.keymap.set("n", "bcn", "<CMD>BufferLineCycleNext<CR>")
		vim.keymap.set("n", "bcp", "<CMD>BufferLineCyclePrev<CR>")
